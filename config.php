...
if($_POST){
   ...
   if (count($errors) == 0) {
      ...
      //$imgName = $usuario->saveAvatar($usuario);


      //instancio la base de datos y le paso al metodo saveUser un usuario y el nombre de la imagen guardada en la variable de arriba.
      //$usuario->setImge($imgName),
      $db->saveUser($usuario);
